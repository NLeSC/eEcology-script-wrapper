...
for k=1:length(KDevice)
    ...
    sql1 = strcat('select t.device_info_serial, t.date_time, a.date_time, ', ...
               ...
               ' t.positiondop, t.satellites_used, t.speed_2d AS speed, count(a.index) as n_acc_points,  ',...
               ' altitude_agl AS AGL ',...
               ...
               ' group by   t.device_info_serial, t.date_time, a.date_time, t.speed_2d, t.longitude, t.altitude_agl,' , ...
